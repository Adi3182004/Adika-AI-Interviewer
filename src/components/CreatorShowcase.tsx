...
import portraitImg from "@/assets/creator_portrait.png";
  ...
  return (
    <section className="relative z-10 mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="mt-12">
        <div
          ref={a.ref}
          className={`relative overflow-hidden rounded-3xl bg-[#0a0816] p-8 md:p-10 ${slide(a.shown)}`}
        >
          <div className="grid items-center gap-6 md:grid-cols-[1fr_1.1fr]">
            ...
            <div className="relative flex h-72 items-end justify-center md:h-96">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 50% 50%, #efe9ff 0%, #d9c9ff 55%, #b79bff 100%)",
                  filter: "blur(0.5px)",
                }}
              />
              <img
              ...
              <p className="absolute right-4 top-6 z-20 max-w-[55%] text-right font-display text-3xl leading-[0.95] text-white md:text-5xl">
                ...
                More
                <br />
                to <em className="not-italic text-gold">Have</em>.
              </p>
            </div>
          </div>
        </div>
