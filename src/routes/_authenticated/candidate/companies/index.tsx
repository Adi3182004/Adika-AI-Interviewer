...
const COMPANIES: Company[] = [
  {
    ...
    growth: "+12% YoY",
    summary:
      "Payments infrastructure for the internet. Engineering-driven culture, written-comms first, strong on backend craft.",
    stack: ["Ruby", "Go", "Scala", "Postgres", "Kafka"],
    interview: [
      "System design (deep)",
      "Codecraft (extend a small lib)",
      "Bar raiser",
      "Hiring manager",
    ],
    talkingPoints: [
    ...
    founded: "2010",
    funding: "$8.7B raised · $50B valuation",
    website: "stripe.com",
  ...
  },
  {
    ...
    growth: "+38% YoY",
    summary:
      "Connected workspace. Heavy investment in AI features. Design + engineering tightly coupled.",
    ...
    <CandidateShell eyebrow="Company research" title="Walk in already knowing them">
      <div className="glass mb-6 flex items-center gap-3 rounded-2xl p-4">
        ...
        <Input
          ...
          placeholder="Search Stripe, Notion, Linear…"
